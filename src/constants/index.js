...
const projects = [
  {
    name: 'Sportaabe',
    description:
      'Mobile sports management app for organizing tournaments, managing teams, and tracking sports activities. Features tournament management workflow, real-time updates, and seamless user experience.',
    tags: [
      {
        name: 'reactnative',
    ...
    source_code_link: '',
    live_link:
      'https://play.google.com/store/apps/details?id=com.kamerounsport&pli=1',
  },
  {
    name: 'Lassoos',
    description:
      'Multi-tenant ERP system with invoice management compliant with EU Factur-X standards. Features automated hybrid PDF + XML invoice generation with full data validation.',
    tags: [
      {
        name: 'react',
        color: 'blue-text-gradient',
    ...
    image: lassoos,
    source_code_link: '',
    live_link: 'https://lassoos.com/',
  },
  {
    name: 'Commercia360',
    description:
      'Sales Management Progressive Web App (PWA) for field sales teams with offline-first architecture. Enables order creation without internet, local data persistence, and background synchronization.',
    tags: [
      {
        name: 'pwa',
        color: 'blue-text-gradient',
    ...
    image: commercia,
    source_code_link: '',
    live_link: 'https://commercia360.net/',
  },
  {
